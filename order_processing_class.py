...
class Order:
    ...
    def get_total_with_fees(self) -> float:
        return self._amount + (self._amount * self.payment_method.fee_percent / 100)

    def display_info(self) -> None:
        print(
            f"Order {self._order_id} | Status: {self._status.value} | "
            f"Payment: {self.payment_method.display_name} | "
